  ...
  addDimension() {
    ...
    if (this.type === 4 || this.type === 1) {
      for (let i = 0; i < this.inIndex.length; i++) {
        ...
        if (p1.x === p2.x && p1.y > p2.y && this.isClock === true || p1.x === p2.x && p1.y < p2.y  && this.isClock === false) {
        ...
        if (p1.x === p2.x && p1.y > p2.y && this.isClock === false || p1.x === p2.x && p1.y < p2.y  && this.isClock === true) {
          normal = new Types.Vector3({ x: 1, y: 0 })
          // 右侧
